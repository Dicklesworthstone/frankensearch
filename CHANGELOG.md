...
Scope window: the release reconstruction covers v1.9.1 → v1.10.0 and their 2026-09-08 publication records. The unreleased section also records the subsequent Quill fixes, warm-daemon streaming, model-receipt reuse, and executable acceptance work on 2026-09-09.

## Version Timeline

| Version | Kind | Date | Summary |
|---------|------|------|---------|
| Unreleased | Landed on main | 2026-09-09 | Progressive warm-daemon streaming, FastEmbed receipt reuse, installed quickstart acceptance, Quill correctness and replay repairs |
