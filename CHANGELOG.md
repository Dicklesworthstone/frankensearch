...
Scope window: the release reconstruction covers v1.9.1 → v1.10.0 and their 2026-09-08 publication records. The unreleased section also records subsequent Quill fixes, warm-daemon streaming, model-receipt reuse, executable acceptance, and the GH #43/#46 indexing and loader work through 2026-09-11 (UTC).

## Version Timeline

| Version | Kind | Date | Summary |
|---------|------|------|---------|
| Unreleased | Landed on main | 2026-09-09–11 | Progressive warm-daemon streaming, model receipt/shared-load reuse, one-shot indexing cancellation and pressure checks, installed quickstart acceptance, Quill correctness and replay repairs |
